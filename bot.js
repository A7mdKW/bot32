...
ctx.fillText(`Welcome To .....`
 ...
 client.channels.get("496053397775056896").sendFile(canvas.toBuffer())
          client.channels.get("496053397775056896").send(`Welcome ${member} To **${member.guild.name}**`)
